module.exports = function (RED) {
	...
	function HueButtons(config) {
		...
		this.on('input', function (msg, send, done) {
			...
			if (!currentState) {
				scope.error(
					'The button/switch in not yet available. Please wait until HueMagic has established a connection with the bridge or check whether the resource ID in the configuration is valid.'
				);
				return false;
			}
